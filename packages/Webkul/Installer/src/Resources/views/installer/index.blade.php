...
<head>
    ...
    <link type="image/x-icon" href="{{ vite()->asset('images/favicon.ico', 'installer') }}" rel="shortcut icon"
        sizes="16x16" />
                        ...
                        const stepActions = {
                            envDatabase: () => {
                                if (params.db_connection === 'mysql') {
                                    ...
                                    setErrors({
                                        'db_connection': ["Krayin currently supports MySQL only."]
                                    });
                                }
                            },
