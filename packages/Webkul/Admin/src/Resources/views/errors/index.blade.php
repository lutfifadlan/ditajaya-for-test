    ...
    <div class="flex h-[100vh] items-center justify-center bg-white dark:bg-gray-900">
        <div class="flex max-w-[745px] items-center gap-5">
            <div class="flex w-full flex-col gap-6">
                <img src="{{ request()->cookie('dark_mode') ? vite()->asset('images/dark-logo.png') : vite()->asset('images/logo.png') }}"
            ...
            <div class="w-full">
                <img
                    src="{{ request()->cookie('dark_mode') ? vite()->asset('images/dark-error.svg') : vite()->asset('images/error.svg') }}" />
            </div>
        </div>
    </div>
</x-admin::layouts.anonymous>
