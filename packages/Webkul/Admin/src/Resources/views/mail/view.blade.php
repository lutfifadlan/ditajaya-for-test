        ...
        <div
            ...
            <div class="flex flex-col gap-2">
                <div class="flex cursor-pointer items-center">
                    ...
                    <!-- Bredcrumbs -->
                    <x-admin::breadcrumbs name="mail.route.view" :entity="$email" :route="request('route')" />
                ...
                <div class="flex items-center gap-2">
                    ...
                    <x-admin::tags :attach-endpoint="route('admin.mail.tags.attach', $email->id)" :detach-endpoint="route('admin.mail.tags.detach', $email->id)" :added-tags="$email->tags" />
                    ...
                    emailAction(type) {
                        if (type != 'delete') {
                            ...
                            this.$emitter.emit('open-confirm-modal', {
                                agree: () => {
                                    this.$axios.post(`{{ route('admin.mail.delete', ':id') }}`.replace(
                                            ':id', this.email.id), {
                                            _method: 'DELETE',
                                            type: 'trash'
                                        })
