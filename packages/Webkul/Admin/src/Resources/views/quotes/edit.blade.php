<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.quotes.update', $quote->id)" method="PUT">
            ...
            app.component('v-quote', {
                ...
                data() {
                    return {
                        ...
                        tabs: [{
                                id: 'quote-info',
                                label: '@lang('admin::app.quotes.create.quote-info')'
                            },
                            {
                                id: 'address-info',
                                label: '@lang('admin::app.quotes.create.address-info')'
                            },
                            {
                                id: 'quote-items',
                                label: '@lang('admin::app.quotes.create.quote-items')'
                            }
                        ],
                    };
                },
            ...
            app.component('v-quote-item-list', {
                ...
                computed: {
                    ...
                    grandTotal() {
                        ...
                        this.products.forEach(product => {
                            total += parseFloat(product.price * product.quantity) + parseFloat(product
                                .tax_amount) - parseFloat(product.discount_amount) + parseFloat(this
                                .adjustmentAmount);
                        });
