<x-admin::layouts>
    ...
    <div class="flex flex-col gap-4">
        <div
            ...
            <div class="flex flex-col gap-2">
                <div class="flex cursor-pointer items-center">
                    ...
                    <!-- Breadcumbs -->
                    <x-admin::breadcrumbs name="stock.stockout.index" />
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                <div class="flex items-center gap-x-2.5">
                    ...
                    {{-- @if (bouncer()->hasPermission('stockout')) --}}
                    <a href="{{ route('admin.stock.stockout.create') }}" class="primary-button">
                        Create Stock Out
                    </a>
                    {{-- @endif --}}
        ...
        <x-admin::datagrid :src="route('admin.stock.stockout.index')">
            <!-- DataGrid Shimmer -->
