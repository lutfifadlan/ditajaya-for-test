...
<div>
    ...
    {{-- <button
        class=" px-2 py-1 flex items-center justify-center gap-1 rounded-lg border border-transparent bg-white font-medium text-slate-800 transition-all hover:border-blue-400"
        @click="$refs.actionComponent.openModal()">
        <span class="icon-add dark:!text-blue-800"></span>

        Add Activity
    </button> --}}

    <div class="rounded-lg bg-white p-2 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-950">
        <button @click="$refs.actionComponent.openModal()">

            <div class="flex flex-col gap-1">
                <i class="icon-activity text-2xl text-gray-600"></i>

                <span class="font-medium dark:text-gray-300">Activity</span>
            </div>
        </button>
    </div>
    ...
    <v-activity ref="actionComponent"></v-activity>
        ...
        app.component('v-activity', {
            ...
            methods: {
                openModal() {
                    ...
                    this.$refs.activityModal.open(); // Ensure the modal is accessible via this.$refs.activityModal
                },
