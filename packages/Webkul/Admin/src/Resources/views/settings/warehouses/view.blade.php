<x-admin::layouts>
    ...
    <div class="flex gap-4">
        ...
        <div
            class="[&>div:last-child]:border-b-0 sticky top-[73px] flex min-w-[394px] max-w-[394px] flex-col self-start rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
            <!-- Product Information -->
            <div class="flex w-full flex-col gap-2 border-b border-gray-200 p-4 dark:border-gray-800">
                ...
                <!-- Tags -->
                <x-admin::tags :attach-endpoint="route('admin.settings.warehouses.tags.attach', $warehouse->id)" :detach-endpoint="route('admin.settings.warehouses.tags.detach', $warehouse->id)" :added-tags="$warehouse->tags" />
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <x-admin::activities.actions.file :entity="$warehouse" entity-control-name="warehouse_id" />
                    ...
                    <x-admin::activities.actions.note :entity="$warehouse" entity-control-name="warehouse_id" />

                    {!! view_render_event('admin.settings.warehouses.view.left.actions.note.after', ['warehouse' => $warehouse]) !!}

                    {!! view_render_event('admin.settings.warehouses.view.left.actions.activity.before', [
                        'warehouse' => $warehouse,
                    ]) !!}

                    <!-- Activity Action -->
                    <x-admin::activities.actions.activity :entity="$warehouse" entity-control-name="warehouse_id" />
        ...
        <div class="flex w-full flex-col gap-4 rounded-lg">
            ...
            <!-- Activity Navigation -->
            <x-admin::activities :endpoint="route('admin.settings.warehouse.activities.index', $warehouse->id)" :types="[
            ...
            ]" :extra-types="[['name' => 'location', 'label' => trans('admin::app.settings.warehouses.view.location')]]">
                <x-slot:location>
