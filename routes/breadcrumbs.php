...
// Stock
Breadcrumbs::for('stock.stockout.index', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push("Stock Out", route('admin.stock.stockout.index'));
});
Breadcrumbs::for('stock.stockin.index', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push("Stock In", route('admin.stock.stockin.index'));
});
Breadcrumbs::for('stock.stockin.create', function (BreadcrumbTrail $trail) {
    $trail->parent('stock.stockin.index');
    $trail->push("Create Stock In", route('admin.stock.stockin.create'));
});

Breadcrumbs::for('stock.stockout.create', function (BreadcrumbTrail $trail) {
    $trail->parent('stock.stockout.index');
    $trail->push("Create Stock In", route('admin.stock.stockout.create'));
});

// Technician
Breadcrumbs::for('technician.index', function (BreadcrumbTrail $trail) {
    $trail->push("Technician Activity", route('admin.technician.index'));
});

Breadcrumbs::for('technician.create', function (BreadcrumbTrail $trail) {
    $trail->parent('technician.index');
    $trail->push("Create Technician Activity", route('admin.technician.create'));
});
